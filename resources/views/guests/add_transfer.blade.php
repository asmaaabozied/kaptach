...
@section('content')
    <section class="content">
        <div class="row">
            {!! BootForm::open('create', ['url'=>route('guests.transfer_store',$guest->id),'id'=>'basic-form','class'=>'form-horizontal']) !!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable"
                                ...
                                <tbody>
                                <tr>
                                    <td><label class=" form-control">{{$guest->identity_number}}</label>
                                    </td>
                                    <td><label class="form-control">{{$guest->first_name}}</label>
                                    </td>
                                    <td><label class="form-control">{{$guest->last_name}}</label>
                                    </td>
                                    <td><label class="form-control">{{$guest->gender}}</label></td>
                                    <td><label class="form-control">{{$guest->nationality}}</label>
                                    </td>
                                    <td><label class="form-control">{{$guest->phone}}</label>
                                    </td>
