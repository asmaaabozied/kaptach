        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">{{__('pages.cars')}}</h3>
                    <a id="addToTable" class="btn btn-primary pull-right" href="{{route('cars.create')}}">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th>{{__('pages.plate_number')}}</th>
                            <th>{{__('pages.color')}}</th>
                            <th>{{__('pages.brand')}}</th>
                            <th>{{__('pages.licence_plate')}}</th>
                            <th>{{__('pages.manufacture_year')}}</th>
        ...
        $(function () {
            $('#example1').DataTable({
                ...
                columns: [
                    ...
                    {data: 'manufacture_year', name: 'manufacture_year'},
