...
@section('content')
    <section class="content">
        <div class="row">
            {!! BootForm::open('create', ['url'=>route('transfers.store_duplicate_transfer',[$transfer->id,$airport->id,$type]),'id'=>'basic-form','class'=>'form-horizontal']) !!}
                        ...
                        <div class="col-xs-5">
                            <div class="form-group">
                                ...
                                <div class="input-group date form_datetime col-xs-8">
                                    <input class="form-control" size="16" type="text"
                                           value="{{$transfer->transfer_start_time}}" readonly required
                            ...
                            @if($type=='arrival')
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="flight_number" value="{{$transfer->flight_number}}"
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="car_model_id" id="car_model_id" required
                                        ...
                                        @foreach ($car_models as $car_model)
                                            <option value="{{$car_model->id}}"@if($car_model->id==$transfer->car_model_id){{'selected'}}@endif>{{$car_model->ModelWithSeats}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="hotel_id" id="hotel_id" required
                                        ...
                                        @foreach ($hotels as $hotel)
                                            <option value="{{$hotel->id}}"@if($transfer->transferable->id==$hotel->id){{'selected'}}@endif>{{$hotel->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" value="{{$transfer->number_of_booking}}" min="1" name="number_of_booking"
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                       ...
                       <textarea rows="4" class="form-control no-resize"
                                 placeholder="{{__('inputs.placeholder_notes')}}" name="notes" value="{{$transfer->notes}}"></textarea>
                            </div>
                        </div>
                    </div>
