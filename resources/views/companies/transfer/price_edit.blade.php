...
@section('title',__('pages.edit'). __('pages.transfer'). __('pages.price'))
    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="box">
                ...
                <!-- /.box-header -->
                {!! BootForm::model($transfer_price, 'edit', ['method'=>'put', 'route'=>['transfers-price.update',$transfer_price->id]],['id'=>'basic-form']) !!}
                <div class="box-body">
