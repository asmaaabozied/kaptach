        ...
        <div class="row">
            <div class="col-xs-6">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    {!! BootForm::model($client, 'edit', ['method'=>'put', 'route'=>['my-clients.update',$client->id],'files'=>true],['id'=>'basic-form']) !!}
                    <div class="box-body">
                    ...
                    <div id="divPosition" style="visibility: hidden; display:inline;">
                        {!! BootForm::input('text', 'lat', $client->lat, __('inputs.lat'), $errors, ['required','class'=>'form-control','id'=>'lat']) !!}
                        {!! BootForm::input('text', 'lang', $client->lang, __('inputs.lang'), $errors, ['required','class'=>'form-control','id'=>'lang']) !!}
                    </div>
                {!! BootForm::close() !!}
                <!-- /.box-body -->
                </div>
...
@section('scripts')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDFkSLH-JOeEK-00L0sE8-usUl7yH_ZK4Y&libraries=places&callback=initMap"
            async defer>
    </script>
    <script>
