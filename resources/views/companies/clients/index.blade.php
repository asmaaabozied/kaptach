...
@section('title',__('pages.my_clients'))
@section('styles')
    <!-- DataTables -->
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">{{__('pages.my_clients')}}</h3>
                    <a id="addToTable" class="btn btn-primary pull-right" href="{{route('my-clients.create')}}">
