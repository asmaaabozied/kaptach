        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    ...
                    <small class="pull-right">{{__('pages.date')}}
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    {{$invoice->address}}<br>
                    {{__('pages.phone')}}: {{$invoice->contact_phone}}<br>
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    {{__('pages.phone')}}: {{$to_corporate->contact_phone}}<br>
                    {{__('pages.email')}}: {{$to_corporate->contact_email}}
                </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="#" target="_blank" class="btn btn-default" id="print"><i class="fa fa-print"></i>
                    {{__('buttons.print')}}</a>
                <a type="button" href="{{route('invoices.downloadPDF', $invoice->id)}}"
                   class="btn btn-primary pull-right" style="margin-right: 5px;">
                    <i class="fa fa-download"></i> {{__('buttons.generate_dpf')}}
                </a>
                <a type="button" href="{{route('invoices.edit', $invoice->id)}}"
                   class="btn btn-primary pull-right" style="margin-right: 5px;">
