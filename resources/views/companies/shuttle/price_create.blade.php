...
@section('title',__('pages.create'). __('pages.shuttle'). __('pages.price') )
        ...
        <div class="col-xs-6">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">{{__('pages.create'). __('pages.shuttle'). __('pages.price')}}</h3>
                </div>
                <!-- /.box-header -->
                {!! BootForm::open('create', ['url'=>route('shuttles-price.store'),'id'=>'basic-form']) !!}
                <div class="box-body">
