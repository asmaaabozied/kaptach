        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="col-lg-3"><a href="{{route('shuttles.create',['id'=>$airport->id,'type'=>$type])}}"
                                             class="btn btn-info  btn-block">{{__('buttons.add_ride')}}</a></div>
                </div>
                <div class="box-body">
                    <form>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#list').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{route('shuttles.schedule',['id'=>$airport->id,'type'=>$type])}}",
                    type: 'GET',
                    data: function (d) {
