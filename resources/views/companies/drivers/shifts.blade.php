...
@section('content')
    ...
    <div id="calendarModal" class="modal fade">
        {!! BootForm::open('create', ['url'=>route('shifts.store'),'id'=>'basic-form']) !!}
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div id="modalBody" class="modal-body">
                    {!! BootForm::select('driver_id','Driver',$drivers->prepend('Select Driver',''),null,$errors,['required','class'=>'form-control']) !!}
        ...
        $(function () {
            ...
            $('#calendar').fullCalendar({
                ...
                events: [
                    ...
                    {
                        title: '{{$shift->driver->employer->username}}',
