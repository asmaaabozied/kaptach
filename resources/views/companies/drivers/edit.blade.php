        ...
        <div class="row">
            <div class="col-xs-6">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    {!! BootForm::model($driver, 'edit', ['method'=>'put', 'route'=>['drivers.update',$driver->id],'files'=>true],['id'=>'basic-form']) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group @error('phone'){{'has-error'}} @enderror">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control form-control" name="phone" type="text" id="phone" value="{{$driver->phone}}">
                            </div>
                            @error('phone')
