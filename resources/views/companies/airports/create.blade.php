...
@section('title',__('pages.create_airports'))
            ...
            <div class="col-xs-6">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{__('pages.create_airports')}}</h3>
                    </div>
                    <!-- /.box-header -->
                    {!! BootForm::open('create', ['url'=>route('airports.store'),'id'=>'basic-form','files'=>true]) !!}
                    <div class="box-body">
                        ...
                        {!! BootForm::file('arrival_image', __('inputs.arrival').' '.__('inputs.image'), $errors, ['accept'=>'png,jpg,jpeg','required']) !!}
                        {!! BootForm::file('departure_image', __('inputs.departure').' '.__('inputs.image'), $errors, ['accept'=>'png,jpg,jpeg','required']) !!}
